...
from decorators.permissions import autherization
...
class Employee:
    ...
    @autherization
    def add_employee(self,user_obj,model_obj):
        self.employee_data.append(dict(model_obj))
        save_data(self.employee_data)

    @autherization
    def view_employees(self,user_obj):
    ...
    @autherization
    def update_bonus(self,user_obj):
        for emp_info in self.employee_data:
            ...
            print("Employee experience:", emp_info['experience'])
    @autherization        
    def search_employee(self,user_obj,emp_id):
        for emp_info in self.employee_data:
    ...
    @autherization
    def update_employee(self,user_obj,emp_id,updated_employee_info):
        for emp_info in self.employee_data:
            if emp_info['emp_id'] == emp_id:
        ...
        save_data(self.employee_data)
    @autherization
    def delete_employee(self,user_obj, emp_id):
